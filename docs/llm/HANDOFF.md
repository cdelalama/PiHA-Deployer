...
- `home-assistant/mariadb/README.md` now promotes the manual NAS bootstrap flow (with the single-command helper) and the helper script works on BusyBox/bash 3 shells
...
- home-assistant/mariadb/setup-nas-mariadb.sh: 1.0.2
