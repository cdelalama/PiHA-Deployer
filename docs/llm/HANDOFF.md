...
- `home-assistant/uninstall-home-assistant.sh` new teardown helper for full resets (falls back to NAS_IP when NAS_SSH_HOST=localhost)
...
- home-assistant/uninstall-home-assistant.sh (new teardown helper, v1.0.1)
