...
- home-assistant/mariadb/setup-nas-mariadb.sh (local-bypass + direct-copy fallback, v1.0.5)
- docs/NAS_CONFIGURATION.md (NAS directory prep snippet + one-liner reference)
- docs/llm/HISTORY.md (this entry)

Version impact: yes (home-assistant/mariadb/setup-nas-mariadb.sh -> 1.0.5)
