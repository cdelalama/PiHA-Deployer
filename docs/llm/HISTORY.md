...
Summary: Added a scripted teardown that stops the HA stack, removes NAS-hosted data directories, and (optionally) cleans the NAS MariaDB deployment over SSH (falling back to NAS_IP when NAS_SSH_HOST=localhost) to ease fresh reinstall workflows.

Files updated:
- home-assistant/uninstall-home-assistant.sh (new helper script, v1.0.1)
...
Version impact: yes (home-assistant/uninstall-home-assistant.sh -> 1.0.1)
...
Version impact: yes (home-assistant/uninstall-home-assistant.sh -> 1.0.1) (compose files only)
...
Version impact: yes (home-assistant/uninstall-home-assistant.sh -> 1.0.1) (code behavior unchanged)
...
Version impact: yes (home-assistant/uninstall-home-assistant.sh -> 1.0.1) (new component scaffolding; existing components unchanged)
...
Version impact: yes (home-assistant/uninstall-home-assistant.sh -> 1.0.1) (path behavior follows .env; default derivation only when env not set)
...
Version impact: yes (home-assistant/uninstall-home-assistant.sh -> 1.0.1) (env/config only)
...
Version impact: yes (home-assistant/uninstall-home-assistant.sh -> 1.0.1) (behavior safer; no functional change intended)
...
Version impact: yes (home-assistant/uninstall-home-assistant.sh -> 1.0.1) (documentation only)
...
Version impact: yes (home-assistant/uninstall-home-assistant.sh -> 1.0.1) (documentation cleanup only)
...
Version impact: yes (home-assistant/uninstall-home-assistant.sh -> 1.0.1) (documentation/policy only)
...
Version impact: yes (home-assistant/uninstall-home-assistant.sh -> 1.0.1) (structural reorganization, no code logic changes)
