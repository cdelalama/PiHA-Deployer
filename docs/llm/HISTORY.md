...
Summary: Mosquitto NAS bootstrap now enforces secure permissions on the data directory/mosquitto.db and tolerates NAS shares that reject chown by falling back to chmod 770, keeping the healthcheck green without manual fixes.

Files updated:
- infrastructure/mqtt/setup-mosquitto.sh (now 1.0.5)
...
## 2025-10-10 - Codex - Refine HAOS heartbeat automation\n\nSummary: Simplified the heartbeat payload to the contract fields (ts, host_id) and documented the deployment/automation TODO in the leadership README.\n\nFiles updated:\n- application/home-assistant/leadership/automations/heartbeat.yaml\n- application/home-assistant/leadership/README.md\n\nVersion impact: no\n---\n
- 2026-09-23 - Codex - Adopted DocKit 4.16.3 delivery controls, visible skipped checks and exact Opus 5.5 high review policy. Existing deployment and acceptance gates remain unchanged. Files: docs/llm/DOCKIT_ADOPTION.md, LLM_START_HERE.md, scripts/dockit-delivery-*, scripts/dockit-validate-session.sh, docs/DELIVERY_CONTRACT.md. Version impact: component versions unchanged; no component code changed. Independent review: claude-opus-5-5/high, modelUsage verified, session e06df549-3d43-4283-90a3-4f1833f7af04; candidate tree 3dff97726d6d9f84c813cbfdb8fdfb8722f7d8ec; CLI selected exact --model and --effort with read-only Read/Glob/Grep, restricted/dontAsk/empty MCP. Final source-only delta verdict and validation packet: LLM-DocKit/docs/FLEET_ROLLOUT_2026-09-23.md.
